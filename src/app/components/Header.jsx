      ...
      <div className="relative">
        ...
        <div className="relative z-50 py-3 sm:py-5 xl:py-10 container px-4 md:px-5 xl:px-0 mx-auto">
          <div className="flex justify-between items-center">
            ...
            <div className="text-base font-medium font-geist bg-primary  shadow-[#a37ef229] shadow-[0_10px_10px_rgba(163_126_242_0.16)] border border-lightpurple44  p-1 rounded-[12px] cursor-pointer hidden lg:flex scale-[1.1]">
